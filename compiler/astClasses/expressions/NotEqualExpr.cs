        ...
        private void CheckType()
        {
            ...
            switch (this.left.type)
            {
                ...
                case BooleanType booleanType:
                    ...
                    break;
                default:
                    throw new ArgumentException($"Unknown type {this.left.type.typeName}");
            }

            if (hasToThrow)
                throw new ArgumentException($"Could not compare {this.left.type.typeName} with {this.right.type.typeName}");
        }
    }
}